...
// ExcelsisView is an import-only decoder.  Do not load the exporting,
// scheduling, or rendering plug-ins into the contained parser process.
    IFXString path = "";
#ifdef WIN32
    IFXString plugins = "IFXImporting.dll:";
#else
	IFXString plugins = "libIFXImporting.so:";
#endif
	m_pluginNumber = 1;
/*
