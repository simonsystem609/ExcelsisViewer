...
ExcelsisView 1.1.34 is licensed under the GNU Affero General Public License
version 3 or later (AGPL-3.0-or-later). The complete
application source is supplied beside the installer as
`SOURCE-ExcelsisView-1.1.34.zip`. It
...
Extract `SOURCE-ExcelsisView-1.1.34.zip`, then from
`ExcelsisView-1.1.34-source/ExcelsisView-1.1.34/app-asar-extract`:
